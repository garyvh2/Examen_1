...
public class Repartidor_Test {
	...
	// 7. Dar Carta
	@Test
	public void Dar_Carta () throws Exception {
		Repartidor _Repartidor = new Repartidor();
		Jugador _Jugador = new Jugador ("Gary", null);

		_Repartidor.DarCarta(_Jugador);
		
		assertEquals(1, _Jugador.getMano().size());
		assertEquals(51, _Repartidor.getNaipe().Size());
